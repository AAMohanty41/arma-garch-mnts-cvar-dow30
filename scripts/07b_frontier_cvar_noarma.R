...
message("=== 07b_frontier_cvar_noarma.R : CVaR frontier from MNTS sims (no ARMA) ===")
...
sim_path <- "data/processed/sims_mnts_21d_noarma.rds"
...
out_path <- "outputs/tables/frontier_cvar_21d_noarma.csv"
...
message("=== Done: CVaR frontier from MNTS 21d sims (no ARMA) ===")
