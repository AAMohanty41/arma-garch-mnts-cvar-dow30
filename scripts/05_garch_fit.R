...
saveRDS(eps_dt,   file = "data/processed/eps_daily.rds")
saveRDS(sigma_dt, file = "data/processed/sigma_daily.rds")
fwrite(qa,        file = "outputs/qa/garch_fit_summary.csv")

message("Saved: data/processed/eps_daily.rds")
message("Saved: data/processed/sigma_daily.rds")
message("Saved: outputs/qa/garch_fit_summary.csv")
